...
function Testimonials(props) {
    ...
    return (
        <section className="ctm-pack-section ctm-pack-section-testimonial">
            <div className="ctm-pack-testimonial-heading ctm-pack-text-black ctm-pack-fw-500 ctm-pack-f-48">
                <div>what student say</div>
                <div className="ctm-pack-text-pink ctm-pack-fw-700">about us</div>
            </div>
            <div className="ctm-pack-slider-container">
                <Slider {...settings}>
                    {
                        testimonial.map((item, idx) => {
                            return (
                                <div className="ctm-pack-outer-testimonial-card" key={idx}>
                                    <div className="ctm-pack-testimonial-card">
                                        <div className="ctm-pack-testimonial-card-top">
                                            <div className="ctm-pack-tct-l">
                                                <div className="ctm-pack-tct-icon" style={item.iconStyle}>
                                                    {item.name.charAt(0)}
                                                </div>
                                                <div className="ctm-pack-tct-about">
                                                    <div className="ctm-pack-tct-name">{item.name}</div>
                                                    <Star count={item.star} />
                                                </div>
                                            </div>
                                            <div className="ctm-pack-tct-r">
                                        ...
                                        <div className="ctm-pack-testimonial-card-bottom">
                                            {item.message}
                                        </div>
                                    </div>
                                </div>
